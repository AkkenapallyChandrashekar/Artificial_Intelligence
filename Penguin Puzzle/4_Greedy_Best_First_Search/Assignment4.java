...
//This method helps use the write the puzzle, score and the path travelled by the penguin.
	...
	public Puzzle BFS(Puzzle initialPuzzle) {
		...
		while(!frontier.isEmpty()) {
			...
			if(tempPuzzle.fishesEatenCount >= 20) {//When the score is reached we are updating the depth status as the solution is found at the given depth
	...
	public static void main(String[] args) {
		...
		puzzle = (new Assignment4()).BFS(puzzle);//Calling the BFS function
